...
function wireControls() {
  ...
  document.getElementById('tabBtnWeather').addEventListener('click', () => switchTab('weatherTab', renderDataSourcesPanel));
  ...
  document.getElementById('btnOpenWeatherTab').addEventListener('click', () => {
    toggleSidebar(true);
    switchTab('weatherTab', renderDataSourcesPanel);
  });
